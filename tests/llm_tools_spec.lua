...
local ls = require("neopilot.llm_tools.ls")
local grep = require("neopilot.llm_tools.grep")
local glob = require("neopilot.llm_tools.glob")
local view = require("neopilot.llm_tools.view")
local bash = require("neopilot.llm_tools.bash")
...
describe("llm_tools", function()
  ...
  describe("ls", function()
    it("should list files in directory", function()
      ...
      assert.is_nil(err)
      assert.falsy(result:find("neopilot.nvim"))
