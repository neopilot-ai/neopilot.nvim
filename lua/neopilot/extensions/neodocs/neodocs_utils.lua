local codeBlock = require('neodocs_utils').codeBlock
...
function castToNeodocsCallout(str)
...
function Writer(doc, opts)
  ...
  filter = {
    ...
    Callout = function(node)
      ...
      local neodocsCallout = castToNeodocsCallout(node.type)
      admonition.content:insert(jsx("<" .. neodocsCallout .. ">"))
      if node.title then
