...
local ReActParser = require("neopilot.libs.ReAct_parser2")
...
---@param opts NeopilotPromptOptions
function M.get_user_message(opts)
  vim.deprecate("get_user_message", "parse_messages", "0.1.0", "neopilot.nvim")
  return table.concat(
    vim
      .iter(opts.messages)
...
---@param usage neopilot.OpenAITokenUsage | nil
...
function M:parse_response(ctx, data_stream, _, opts)
  ...
  ---@cast jsn NeopilotOpenAIChatResponse
...
function M:parse_response_without_stream(data, _, opts)
  ---@type NeopilotOpenAIChatResponse
...
function M:parse_curl_args(prompt_opts)
  ...
  if M.is_openrouter(provider_conf.endpoint) then
    headers["HTTP-Referer"] = "https://github.com/neopilot-ai/neopilot.nvim"
    headers["X-Title"] = "Neopilot.nvim"
