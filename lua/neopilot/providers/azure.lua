---@class NeopilotAzureExtraRequestBody
---@field temperature number
---@field max_completion_tokens number
---@field reasoning_effort? string

---@class NeopilotAzureProvider: NeopilotDefaultBaseProvider
---@field deployment string
---@field api_version string
---@field extra_request_body NeopilotAzureExtraRequestBody

local Utils = require("neopilot.utils")
local P = require("neopilot.providers")
local O = require("neopilot.providers").openai
