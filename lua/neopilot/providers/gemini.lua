...
local OpenAI = require("neopilot.providers").openai
...
---@param provider_instance NeopilotProviderFunctor The provider instance (self).
---@param prompt_opts NeopilotPromptOptions Prompt options including messages, tools, system_prompt.
...
---@param usage neopilot.GeminiTokenUsage | nil
