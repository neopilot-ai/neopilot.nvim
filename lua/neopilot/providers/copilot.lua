...
local copilot_path = vim.fn.stdpath("data") .. "/neopilot/github-copilot.json"
local lockfile_path = vim.fn.stdpath("data") .. "/neopilot/copilot-timer.lock"
...
function H.refresh_token(async, force)
  ...
  local function handle_response(response)
    if response.status == 200 then
      ...
      if not vim.g.neopilot_login then vim.g.neopilot_login = true end
...
function M.setup()
  ...
  require("neopilot.tokenizers").setup(M.tokenizer_id)
