...
---@type neopilot.LLMToolOnRender<AttemptCompletionInput>
function M.on_render(input)
  local lines = {}
  table.insert(lines, Line:new({ { "✓  Task Completed", Highlights.NEOPILOT_TASK_COMPLETED } }))
...
---@type NeopilotLLMToolFunc<AttemptCompletionInput>
function M.func(input, opts)
  ...
  then
    ...
    require("neopilot.llm_tools.bash").func({ command = input.command }, opts)
  else
