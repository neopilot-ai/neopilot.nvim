...
M.enabled = function()
  return require("neopilot.config").mode == "agentic" and require("neopilot.config").behaviour.enable_fastapply
end
...
---@type NeopilotLLMToolFunc<{ path: string, instructions: string, code_edit: string }>
M.func = vim.schedule_wrap(function(input, opts)
  ...
  vim.system(
    ...
    vim.schedule_wrap(function(result)
      ...
      local str_replace = require("neopilot.llm_tools.str_replace")
      local new_input = {
        path = input.path,
