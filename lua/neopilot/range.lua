---@class neopilot.Range
---@field start neopilot.RangeSelection start point
---@field finish neopilot.RangeSelection Selection end point
local Range = {}
Range.__index = Range

---@class neopilot.RangeSelection: table<string, integer>
---@field lnum number
---@field col number

---Create a selection range
---@param start neopilot.RangeSelection Selection start point
---@param finish neopilot.RangeSelection Selection end point
