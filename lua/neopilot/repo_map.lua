...
function RepoMap._build_repo_map(project_root, file_ext)
  ...
  if filepaths and not RepoMap._init_repo_map_lib() then
    ...
    Utils.error("Failed to load neopilot_repo_map")
    return
  end
