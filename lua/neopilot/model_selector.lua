...
function M.open()
  ...
  local function on_select(item_ids)
    ...
    if choice.provider_name ~= Config.provider then require("neopilot.providers").refresh(choice.provider_name) end
