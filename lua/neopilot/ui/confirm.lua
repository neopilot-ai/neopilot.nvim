...
function M:new(message, callback, opts)
  ...
  this._ns_id = vim.api.nvim_create_namespace("neopilot_confirm")
  return this
end
...
function M:open()
  ...
  local commentfg = Highlights.NEOPILOT_COMMENT_FG
  ...
  self._group = self._group and self._group or vim.api.nvim_create_augroup("NeopilotConfirm", { clear = true })
