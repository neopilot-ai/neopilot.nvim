...
---@class neopilot.ui.PromptInputOptions
---@field start_insert? boolean
...
---@param opts? neopilot.ui.PromptInputOptions
function PromptInput:new(opts)
  ...
  obj.popup_hint_id = vim.api.nvim_create_namespace("neopilot_prompt_input_hint")
  return obj
end
...
function PromptInput:open()
  ...
  self.bufnr = bufnr
  vim.bo[bufnr].filetype = "NeopilotPromptInput"
  ...
  api.nvim_set_option_value(
    "winhighlight",
    "FloatBorder:NeopilotPromptInputBorder,Normal:NeopilotPromptInput",
    { win = winid }
  )
