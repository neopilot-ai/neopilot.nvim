...
---@class neopilot.HistoryMessage.Opts
---@field uuid? string
---@field turn_id? string
---@field state? neopilot.HistoryMessageState
---@field displayed_content? string
---@field original_content? NeopilotLLMMessageContent
---@field selected_code? NeopilotSelectedCode
...
---@param opts? neopilot.HistoryMessage.Opts
