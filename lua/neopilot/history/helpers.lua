...
---@param message neopilot.HistoryMessage
---@return NeopilotLLMToolResult | nil
function M.get_tool_result_data(message)
  ...
  if type(content) == "table" then
    ...
    if item.type == "tool_result" then
      ---@cast item NeopilotLLMToolResult
      return item
    end
  end
end
...
---@param id string
---@param messages neopilot.HistoryMessage[]
---@return neopilot.HistoryMessage | nil
