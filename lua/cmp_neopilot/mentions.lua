...
---@field get_mentions fun(): NeopilotMention[]
local MentionsSource = {}
MentionsSource.__index = MentionsSource

---@param get_mentions fun(): NeopilotMention[]
...
function MentionsSource:is_available()
  return vim.bo.filetype == "NeopilotInput" or vim.bo.filetype == "NeopilotPromptInput"
end
